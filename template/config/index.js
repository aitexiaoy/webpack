...
const proxy = require('./proxy-table.js');
...
module.exports = {
    ...
    alone: {
        ...
        index: path.resolve(__dirname, '../dist_alone/index.html'),
        login: path.resolve(__dirname, '../dist_alone/login.html'),
        admin: path.resolve(__dirname, '../dist_alone/admin.html'),

        // Paths

        assetsRoot: path.resolve(__dirname, '../dist_alone'),
        assetsSubDirectory: 'static',
        assetsPublicPath: '/',
